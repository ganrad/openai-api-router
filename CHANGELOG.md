...
* (Enhancement) The most significant update in this latest release is full support for chat completion streaming API calls, including On Your Data (OYD) API. Most importantly, the streaming feature works seamlessly with the API router, semantic caching and state management features.
