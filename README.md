...
| **Semantic Caching** | Azure AI Foundry Models | The gateway provides a three-tier vector cache: Level 1 (in-memory, ultra-fast for limited data), Level 2 (Qdrant, scalable and enterprise-grade), and Level 3 (PostgreSQL, default, highly available). When semantic caching is enabled, the gateway stores prompts and completions in the cache, reusing them for semantically similar queries. This significantly reduces latency and enhances efficiency, delivering up to a 40% boost in AI application performance when caching is enabled. |
...
6. Run the AI Application Gateway.
   ...
   ```bash
   > ai-app-gateway@2.9.5 start
   > node --trace-warnings ./src/server.js

   05-Dec-2025 21:02:38 [info] [server.js] Starting initialization of AI Application Gateway ...
   05-Dec-2025 21:02:39 [info] [server.js] Azure Application Monitor OpenTelemetry configured.
   05-Dec-2025 21:02:39 [info] [cp-pg.js] checkDbConnection(): Postgres DB connectivity OK!
   05-Dec-2025 21:02:39 [info] [server.js] Completions will be cached
   05-Dec-2025 21:02:39 [info] [server.js] Prompts will be persisted
   05-Dec-2025 21:02:39 [info] [server.js] Conversational state will be managed
   05-Dec-2025 21:02:39 [info] [validate-json-config.js] validateAiServerSchema():
   Result:
   {
   "schema_compliant": true,
   "errors": "None"
   }
   05-Dec-2025 21:02:39 [info] [server.js] Listing AI Applications:
   ...
   05-Dec-2025 21:02:39 [info] [server.js] Cache entry invalidate run schedule (Cron) - */2 * * * *
   05-Dec-2025 21:02:39 [info] [server.js] Memory (State) invalidate run schedule (Cron) - */4 * * * *
   05-Dec-2025 21:02:39 [info] [authMiddleware.js] validateAccessToken(): AI Gateway Security Configuration:
   {
   ...
   05-Dec-2025 21:02:39 [info] [server.js] Server(): Azure AI Application Gateway started successfully.
   -----
   Details:
