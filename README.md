...
6. Run the AI Application Gateway.
   ...
   ```bash
   > ai-app-gateway@2.9.0 start
   > node ./src/server.js

   14-Nov-2025 05:47:26 [info] [server.js] Starting initialization of AI Application Gateway ...
   14-Nov-2025 05:47:27 [info] [server.js] Azure Application Monitor OpenTelemetry configured.
   14-Nov-2025 05:47:27 [info] [cp-pg.js] checkDbConnection(): Postgres DB connectivity OK!
   14-Nov-2025 05:47:27 [info] [server.js] Completions will be cached
   14-Nov-2025 05:47:27 [info] [server.js] Prompts will be persisted
   14-Nov-2025 05:47:27 [info] [server.js] Conversational state will be managed
   14-Nov-2025 05:47:27 [info] [validate-json-config.js] validateAiServerSchema():
   Result:
   {
   "schema_compliant": true,
   "errors": "None"
   }
   14-Nov-2025 05:47:27 [info] [server.js] Listing AI Applications:
   ...
   14-Nov-2025 05:47:27 [info] [server.js] Cache entry invalidate run schedule (Cron) - */2 * * * *
   14-Nov-2025 05:47:27 [info] [server.js] Memory (State) invalidate run schedule (Cron) - */4 * * * *
   14-Nov-2025 05:47:27 [info] [authMiddleware.js] validateAccessToken(): AI Gateway Security Configuration:
   {
      "endpoint": "/api/v1/dev/aigateway",
      "audience": "d6f78381-40a8-4a12-ab15-x3yf812529f9",
   ...
   14-Nov-2025 05:47:27 [info] [server.js] Server(): Azure AI Application Gateway started successfully.
   -----
   Details:
   ...
   Status: Running
   Start Date: 11/14/2025, 5:47:27 AM
   -----
   ```
